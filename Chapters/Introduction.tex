\lhead{Introduksjon}
\chapter{Innlending}
%Verden blir i stadig større grad mer digital og folk flest har i dag en liten datamaskin tilgjengelig i form av Smartphone til alle tider. Utvikling av det digitale har skjedd utrolig raskt, og en stor menge arbeid gjenstår for å kunne utnytte alle de tilgjengelige digitale verktøy til størst mulig grad. 
%Formålet med denne oppgaven er å digitalisere noe som pr. i dag kun finnes i papir format, 
%Denne bacheloroppgaven fokuserer akkurat på dette, digitalisere noe som per i dag finnes kun i papir format. 
...
En iterativ metode gjør det mulig å splitte et større prosjekt i mindre, mer håndterlige biter. Utvikling av kode, planlegging og design blir gjennomført i gjenntatte sykluser \cite{method:iterative_fig}. Dermed kan man følge figur \ref{fig:iterative_development} for prosessen gjennom hele utviklingen.
 ...
 \begin{figure}[htbp]
	...
	\caption[Iterativ Utviklings Diagram]{Oversikt over trinnene per syklus i iterativ utvikling. } %\ref{fig:iterative}
...
\subsection{Workflow}
%Skrive masse om workflow, yeahh
\subsubsection{Kunde}
