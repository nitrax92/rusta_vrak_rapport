...
Utover dette har vi ytterligere informasjon i form av seksjoner, her finner man vilkår, generell informasjon, kontakt informasjon og om oss.
 ...
 \begin{figure}[htbp]
	...
	\caption[Forsiden til Nettsiden]{Forsiden til nettsiden. Her kan man se de to valgene kunden kan benytte for å finne frem til bil. Enten vha. Søk etter ledig bil i form av leieperiode, eller liste over alle biler basert på biltype.} %\ref{fig:iterative}
